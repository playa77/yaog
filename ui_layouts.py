# ui_layouts.py for YaOG (yaog.py)
# Version: 3.4.1 (Refactor)
# Description: Custom PyQt layouts used in the application.
...
class FlowLayout(QLayout):
    """
    A custom layout that arranges items horizontally and wraps them to the next line
    if they run out of space (similar to CSS flex-wrap).
    """
